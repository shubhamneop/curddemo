...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">{{__('lables.posts.Posts')}} {{ $post->id }}</div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            </tr><th>{{__('lables.posts.Title')}}</th><td> {{ $post->title }} </td></tr>
                            <tr><th>{{__('lables.posts.Content')}}</th><td> {{ $post->content }} </td></tr>
                            <tr><th>{{__('lables.posts.Category')}}</th> <td>{{ $post->category }} </td></tr>
